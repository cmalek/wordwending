...
2. Checkout your fork: ``git clone https://github.com/your-username/bochord.git``
...
8. Create a pull request at `<https://github.com/cmalek/bochord/pulls>`_ and wait for it to be reviewed and merged.
